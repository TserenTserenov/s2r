...
│                    (проблемы людей,   (сценарии           (внешние роли, │
│                    гипотезы ценности) использования)       коммуникации) │
├──────────────────────────────────────────────────────────────────────────┤
│ X2. Целевая        FX4                FX5                  FX6           │
│     система        Визионер ЦС        Инженер ЦС           Оператор ЦС   │
│                    (функция, границы, (архитектура,        (эксплуатация,│
│                    образ системы)     конструкция)         SRE)          │
├──────────────────────────────────────────────────────────────────────────┤
│ X3. Система        FX7                FX8                  FX9           │
│     создания       Бизнесмен          Организатор          Администратор │
│                    (инвестиции,       разработки           (люди, роли,  │
│                    стратегия)         (DevOps, CI/CD)      бюджеты)      │
└──────────────────────────────────────────────────────────────────────────┘

где X = буква ядра (A, B, C...)
```

> Подробное описание ролей и методов: [02-document-families.md](0.OPS/0.1.Knowledge-Logic/02-document-families.md)
