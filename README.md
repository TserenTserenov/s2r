...
│ (Конструктор)      Принципы         Платформа         Команда      │
...
```
┌────────────────────────────────────────────────────────────────────┐
│ Management (F0)    Предприниматель  Инженер           Менеджер     │
│ (Управление)       (логика)         (структура)       (процессы)   │
└────────────────────────────────────────────────────────────────────┘
```
...
- **Constructor** — систему-конструктор, кто и как создаёт
...
3. **Suprasystem** — надсистема: система клиента, куда входит целевая система, а также описание рынка, конкурентов, других проектных ролей и ограничений
4. **Constructor** — система-конструктор: команда, инструменты, методология
...
|----------|----------|---------|
| System-of-Interest | "Мобильное приложение для учёта личных финансов" | "Крутой продукт для людей" |
| Suprasystem | "Рынок личных финансов РФ, конкурент — приложение X" | "Все люди" |
| Constructor | "Команда 3 человека, React Native, 6 месяцев" | "Мы справимся" |
...
└── content/                     # Контент по SRT (10 семейств)
    ...
    │   ├── 0.1.Meaning/         # Предприниматель (логика и принципы)
    │   ├── 0.2.Architecture/    # Инженер (структура)
    │   ├── 0.3.Operations/      # Менеджер (процессы)
    ...
    └── 3.Constructor/           # F7-F9: Система-конструктор → [Ваше название]
```
