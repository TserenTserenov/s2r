...
| Suprasystem | "Система управления личными финансами пользователя, где приложение — центральный компонент координации финансовых потоков" | "Рынок финтеха" или "Все люди" |
