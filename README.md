...
Системы связаны через **цепочку создания ценности**:

```
[Конечная ценность]
       ↑
A. Impressed-Customer/      # Целевая система (по имени!)
       ↑
B. Mobile-App/              # Наша система 1
       ↑
C. Backend-Service/         # Наша система 2
```
