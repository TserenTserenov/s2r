...
**Описание:** Организация через матрицу Систем-Ролей-Измерений

**Обоснование:** SRD обеспечивает структурированное, но гибкое размещение знаний. Каждый документ имеет чёткое место.
...
Принципы FPF применяются во всех ячейках SRD-матрицы:
