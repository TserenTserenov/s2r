...
Этот документ содержит руководство по работе с Claude Code в контексте SRT-метода и интеграции с First Principles Framework (FPF).
...
- Сообщать о найденных несоответствиях SRT/FPF
